...
const Hero = () => {
    return (
        <section className="relative overflow-hidden bg-slate-950">
            ...
            <div className="absolute left-10 -top-10 h-48 w-48 rounded-full bg-purple-600/20 blur-3xl sm:h-72 sm:w-72"/>
            <div className="absolute bottom-10 -right-10 h-48 w-48 rounded-full bg-cyan-500/20 blur-3xl sm:h-72 sm:w-72"/>
            <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:px-8 lg:py-28">
                <div className="text-center lg:text-left">
                    
                    <h2 className="text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl lg:text-5xl">Build Your Ideal </h2>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-400 sm:text-lg lg:mx-0">
          Explore frontend, backend, database, and tooling options, compare them side by side,and put together the stack that fits your next project.
            ...
            <div className="mt-6 flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
                ...
                bg-linear-to-r from-purple-600 to-cyan-500 px-4 py-2 font-semibold text-white
            ...
            hover:scale-105 hover:border-purple-400 hover:bg-purple-500/40">Learn More</button>
            </div>
            </div>
